...
Public Class CharactersL
    ...
    'Public Function promocion(id As Integer) As DataTable
    ' Dim Comando As New MySqlCommand
    '    Try

    '        ConectarBaseDeDatos()
    '        Dim ds As New DataSet
    '        Dim da As New MySqlDataAdapter("SELECT account,name FROM characters where account =" & id & "  ", ConexionBaseDeDato)
    '        da.Fill(ds)
    '        Return ds.Tables(0)
    '    Catch ex As Exception
    '        Return Nothing
    ...
    Public Function promocion(id As Integer) As DataTable
        ...
        Try
            ConectarBaseDeDatos()
            Dim ds As New DataSet
            Dim da As New MySqlDataAdapter("SELECT account FROM characters where account =" & id & "  ", ConexionBaseDeDato)
            da.Fill(ds)
            Return ds.Tables(0)
        Catch ex As Exception
            Return Nothing
